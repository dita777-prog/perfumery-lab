  ...
  return (
    <div className="panel-layout h-full">
      ...
      {/* Right panel */}
        ...
        {selected ? (
                  <div>
              <button className="md:hidden flex items-center gap-1 p-3 text-sm text-muted-foreground hover:text-foreground border-b border-border w-full" onClick={() => setSelectedId(null)}>
